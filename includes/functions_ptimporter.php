...
/**
* Creates the category options for the project
*
* @param	integer	Project ID.
*
* @return	string	The options ready to be pasted into the template
*/
function ptimporter_build_category_select($projectid)
{
	global $vbulletin;
...
/**
* Creates the issue status options for the project
*
* This mainly shadows the build_issuestatus_select function for consistency
*
* @param	integer	Issue type ID.
*
* @return	string	The options ready to be pasted into the template
*/
function ptimporter_build_issuestatus_select($issuetypeid)
{
	global $vbulletin;
	return build_issuestatus_select($vbulletin->pt_issuetype["$issuetypeid"]['statuses']);
}

/**
* Creates the version options for the project
*
* @param	integer	Project ID.
*
* @return	string	The options ready to be pasted into the template
*/
function ptimporter_build_version_select($projectid)
{
	global $vbulletin, $db;
	...
	$version_query = $db->query_read("
		...
		WHERE projectversion.projectid = $projectid
	...
	foreach ($version_groups AS $optgroup_label => $versions)
	{
		...
		eval('$version_options .= "' . fetch_template('optgroup') . '";');
	}
